                        ...
                        <form onSubmit={submitEdit} className="mt-3 space-y-3">
                          ...
                          <div className="flex items-center gap-2">
                            <button
                              type="submit"
                              disabled={updating}
                              className="px-3 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 disabled:opacity-50 cursor-pointer"
                            >
                            ...
                            <button
                              ...
                              className="px-3 py-2 bg-gray-100 text-gray-800 rounded-md hover:bg-gray-200 cursor-pointer"
                            >
                              Cancel
                            </button>
                          </div>
